...
MADWIFI_HAL_VERSION=r3835-20080801
MY_P=${PN/-ng/-hal}-${PV}-${MADWIFI_HAL_VERSION}
S="${WORKDIR}"/${MY_P}

DESCRIPTION="Next Generation driver for Atheros based IEEE 802.11a/b/g wireless LAN cards"
HOMEPAGE="http://www.madwifi.org/"
SRC_URI="http://snapshots.madwifi.org/madwifi-hal-${PV}/${MY_P}.tar.gz"
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${MY_P}-release_header_fix.patch
